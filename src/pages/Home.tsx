        ...
        <div className="max-w-7xl mx-auto px-6">
           ...
           >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
                 ...
                 <Link to="/nysc" className="bg-white text-prussian px-12 py-6 rounded-2xl font-black text-xl hover:bg-slate-100 transition-all uppercase tracking-widest">APPLY TO NYSC COHORT</Link>
              </div>
